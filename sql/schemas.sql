...
CREATE TABLE OFERTA (
    OFERTA_ID           NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1),
...
CREATE TABLE NOTIFICACION (
    NOTIFICACION_ID     NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1),
...
CREATE TABLE RESPUESTA (
    ...
    MENSAJE             VARCHAR2(50) NOT NULL,
    FECHA               DATE DEFAULT SYSDATE NOT NULL,
    TIPO                VARCHAR2(10) NOT NULL, --USUARIO O ADMINISTRADOR
    USUARIO_ID          NUMBER,
...
CREATE TABLE LISTA_DESEO (
    USUARIO_ID          NUMBER,
    LISTA_DESEO_ID      NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1),
...
CREATE TABLE PRDCTO_LSTA_DSEO (
    LISTA_DESEO_ID      NUMBER,
    PRODUCTO_ID         NUMBER,
    LISTA_DESEO_USUARIO_ID  NUMBER NOT NULL,
    PRODUCTO_VENDEDOR_ID    NUMBER NOT NULL,
