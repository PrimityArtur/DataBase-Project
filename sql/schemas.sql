...
CREATE TABLE PRODUCTO (
    ...
    VENDEDOR_USUARIO_ID          NUMBER(10) NOT NULL,
...
CREATE TABLE TIPO (
    ...
    PRODUCTO_VENDEDOR_ID    NUMBER(10) NOT NULL,
...
CREATE TABLE OFERTA (
    ...
    CONSTRAINT oferta_producto_id_fk FOREIGN KEY (PRODUCTO_ID, PRODUCTO_VENDEDOR_ID) 
        REFERENCES PRODUCTO(PRODUCTO_ID, VENDEDOR_ID),
    CONSTRAINT oferta_vendedor_id_fk FOREIGN KEY (VENDEDOR_ID, VENDEDOR_USUARIO_ID) 
        REFERENCES VENDEDOR(VENDEDOR_ID, USUARIO_ID)
);
...
CREATE TABLE PRDCTO_LSTA_DSEO (
    LISTA_DESEO_ID      NUMBER(10),
    PRODUCTO_ID         NUMBER(10),
    LISTA_DESEO_USUARIO_ID  NUMBER(10) NOT NULL,
    PRODUCTO_VENDEDOR_ID    NUMBER(10) NOT NULL,
    
    CONSTRAINT prdcto_lsta_dseo_id_pk PRIMARY KEY (LISTA_DESEO_ID, PRODUCTO_ID),
    CONSTRAINT prdcto_lsta_dseo_lista_deseo_id_fk FOREIGN KEY (LISTA_DESEO_ID, LISTA_DESEO_USUARIO_ID) 
        REFERENCES LISTA_DESEO(LISTA_DESEO_ID, USUARIO_ID) ON DELETE CASCADE,
    CONSTRAINT prdcto_lsta_dseo_producto_id_fk FOREIGN KEY (PRODUCTO_ID, PRODUCTO_VENDEDOR_ID) 
        REFERENCES PRODUCTO(PRODUCTO_ID, VENDEDOR_ID) ON DELETE CASCADE
);
...
CREATE TABLE PRDCTO_CRRTO (
    ...
    CARRITO_COMPRADOR_ID    NUMBER(10) NOT NULL,
    PRODUCTO_VENDEDOR_ID    NUMBER(10) NOT NULL,
    ...
    CONSTRAINT prdcto_crrto_carrito_id_fk FOREIGN KEY (CARRITO_ID, CARRITO_COMPRADOR_ID) 
        REFERENCES CARRITO(CARRITO_ID, COMPRADOR_ID) ON DELETE CASCADE, 
...
CREATE TABLE RECIBO (
    ...
    PAGO_COMPRADOR_ID       NUMBER(10) NOT NULL,
    PAGO_METODO_PAGO_ID     NUMBER(10) NOT NULL,
    CARRITO_COMPRADOR_ID    NUMBER(10) NOT NULL,
    ...
    CONSTRAINT recibo_pago_id_fk FOREIGN KEY (PAGO_ID, PAGO_COMPRADOR_ID, PAGO_METODO_PAGO_ID) 
        REFERENCES PAGO(PAGO_ID, COMPRADOR_ID, METODO_PAGO_ID) ON DELETE CASCADE, 
